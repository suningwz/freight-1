...
class RekapCreateDOPrintWizard(models.TransientModel):
    _name = 'rekap.create.do.print.wizard'
    _description = 'Wizard untuk cetak rekap create do per hari'
    ...
    def action_get_report(self):
        ...
        return self.env.ref('freight.recap_report_create').report_action(self, data=data)


class DOUnusedRekapPrint(models.AbstractModel):
    _name = 'report.freight.rekap_create_do_print_wizard_view'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        self.env.cr.execute(
            ...
            select d.name as kendaraan, c.name as produk, count(a.id) as qty
                ...
                where a.date + interval '7 hour' >= '%s' and a.date + interval '7 hour' <= '%s' 
